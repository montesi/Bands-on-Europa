function [zout,tout,fout,dn,rout,dcon,tcon]=solvestagnantspread(Vn,Di,etat,k0,K0,eta0,H0,Tb,Ts,Fb,kfun,eta,hfun,Hs,DT,Ra,Th,T0,L0,F0) %% 
...
% bcv [km]: thickness of convecting layer
% btv [km]: thickness of top BL layer 
% bbv [km]: thickness of bottom BL layer 
% biv [km]: thickness of isothermal layer
% Ttv [K]:  Temperature at top
% Tiv [K]:  Temperature of isothermal layer
% Tb [K]:   Temperature at bottom (input)
% DTv [K]:  Temperature drop
% Ftv [W/m^2]:  top heat flux
% Fb  [W/m^2]:  bottom heat flux (input)
...
[znv,tnv,fnv,kout,hout,dnv,rnv]=...
        ConductionSolveSpread(dz,tb,fb,Vn/Vv,kfun,hfun,nz);
Dnv=dnv*Lv;
Znv=(dnv-znv)*Lv;
Tnv=tnv*Tv;
Fnv=fnv*Fv;
